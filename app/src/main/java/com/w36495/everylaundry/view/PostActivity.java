...
import com.w36495.everylaundry.view.adapter.BoardCommentAdapter;
import com.w36495.everylaundry.data.network.CommentAPI;
        ...
        postAPI.deletePost(postKey, loginID).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    Timber.d("delete post : " + response.body());
